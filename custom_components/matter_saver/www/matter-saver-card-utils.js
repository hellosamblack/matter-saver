(() => {
  ...
  const STRINGS = {
    en: {
      ...
      editorMoveItemUp: "Move {name} up",
      editorMoveItemDown: "Move {name} down",
    ...
    de: {
      ...
      editorMoveItemUp: "{name} nach oben verschieben",
      editorMoveItemDown: "{name} nach unten verschieben",
