(() => {
  ...
  const STRINGS = {
    en: {
      ...
      editorFloorOrderHelper: "Drag floors to set their top-to-bottom order for By Floor and dollhouse layouts.",
      editorAreaOrderLabel: "Area order",
      editorAreaOrderHelper: "Drag rooms within each floor to set their left-to-right order for By Area and dollhouse layouts.",
      product: "Product",
      status: "Status",
      thread: "Thread",
      neighbors: "Neighbors",
    ...
    de: {
      ...
      editorFloorOrderHelper: "Etagen ziehen, um ihre Reihenfolge von oben nach unten für Nach-Etage- und Puppenhaus-Layouts festzulegen.",
      editorAreaOrderLabel: "Bereichs-Reihenfolge",
      editorAreaOrderHelper: "Räume innerhalb jeder Etage ziehen, um ihre Reihenfolge von links nach rechts für Nach-Bereich- und Puppenhaus-Layouts festzulegen.",
      product: "Produkt",
      status: "Status",
      thread: "Thread",
      neighbors: "Nachbarn",
